...
namespace ApiCallManager.NetFramework
{
    public interface IApiManager
    {
        ...
        Task<ApiResult<TResponse>> GetAsync<TResponse>(string address, bool sendAccessToken = false, string accesstoken = "", params Tuple<string, string>[] param);
        ...
        /// <param name="accesstoken">Access token. this parameter send in Authorization Header to API.</param>
        /// <returns>API response object in <typeparamref name="TResponse"/> type.</returns>
        Task<ApiResult<TResponse>> PostAsync<TRequest, TResponse>(string address, TRequest input, bool sendAccessToken = false, string accesstoken = "");
        ...
        Task<ApiResult> PostNoResultAsync<TRequest>(string address, TRequest input, bool sendAccessToken = false, string accesstoken = "");
        ...
        /// <param name="accesstoken">Access token. this parameter send in Authorization Header to API.</param>
        /// <returns>API response object in <typeparamref name="TResponse"/> type.</returns>
        Task<ApiResult<TResponse>> PutAsync<TRequest, TResponse>(string address, TRequest input, bool sendAccessToken = false, string accesstoken = "");
        ...
        /// <param name="accesstoken">Access token. this parameter send in Authorization Header to API.</param>
        /// <returns>Call status object.</returns>
        Task<ApiResult> PutNoResultAsync<TRequest>(string address, TRequest input, bool sendAccessToken = false, string accesstoken = "");
        ...
        /// <param name="param">name and value of parameter</param>
        /// <returns>API response object in <typeparamref name="TResponse"/> type.</returns>
        Task<ApiResult<TResponse>> DeleteAsync<TResponse>(string address, bool sendAccessToken = false, string accesstoken = "", params Tuple<string, string>[] param);
        ...
        /// <param name="param">name and value of parameter</param>
        /// <returns>API response object in <typeparamref name="TResponse"/> type.</returns>
        Task<ApiResult> DeleteNoResultAsync(string address, bool sendAccessToken = false, string accesstoken = "", params Tuple<string, string>[] param);
